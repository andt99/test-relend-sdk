...
export class InstrumentedConnection implements RelendRPCConnection {
  connection: RelendRPCConnection
  statsd: StatsD
  prefix: string
  public rpcEndpoint: string

  constructor(connection: RelendRPCConnection, statsd: StatsD, prefix: string = "") {
  ...
  getConfirmedSignaturesForAddress2(
    ...
    return this.withStats(
      this.connection.getConfirmedSignaturesForAddress2(address, options, commitment),
      "getConfirmedSignaturesForAddress2"
    )
  }
