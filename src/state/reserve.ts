...
export const isReserve = (info: AccountInfo<Buffer>) => info.data.length === RESERVE_SIZE

export const parseReserve = (pubkey: PublicKey, info: AccountInfo<Buffer>, encoding?: string) => {
