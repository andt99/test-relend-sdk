...
export const isLendingMarket = (info: AccountInfo<Buffer>) => info.data.length === LendingMarketLayout.span

export const parseLendingMarket = (pubkey: PublicKey, info: AccountInfo<Buffer>, encoding?: string) => {
